...
public async updateSingleBoard(socket:Socket,username:string,level:string,time_completed:string,date_completed:string)
{
    socket.emit('update_single_board',{username:username,level:level,time_complete:time_completed,date_complete:date_completed});
}
