...
import { userInfo,getStatistics,getCommentSection} from "../../services/apiService/api";
...
const DropDownView=()=>{
  ...
  const CLIENT_URL='https://sudoku-master-9ytq.onrender.com';
   ...
   const getCommentSectionVal=async(e)=>
   {
    e.preventDefault();
    await getCommentSection(token);
   }
   ...
   const menu = (
      <HLMenu>
       ...
       <a target="_self" onClick={getUserInfo}>
        ...
        <HLMenu.Item>
          <a target="_self" onClick={getCommentSectionVal}>
            Nhận xét
          </a> 
        </HLMenu.Item>
